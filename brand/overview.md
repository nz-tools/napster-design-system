...
| Axis | Where Napster sits |
|---|---|
| Architectural ↔ Playful | **Architectural.** Confident. Late-night studio rather than a glossy product launch. |
| Editorial ↔ Promotional | **Editorial.** Declarative. Unhedged. *Software just became labor.* |
| Cinematic ↔ Functional | **Cinematic surfaces, functional UI.** Real motion lives in hero video, not in chrome. |
| Warm ↔ Cool | **Warm in photography, cool in interface.** Mulberry depths, pink accent, black canvas. |
| Quiet ↔ Loud | **Quiet.** No exclamation marks. No emoji. No "industry-leading" claims. |
